...
#-------------------------------------------------------------------------------
''' 038. Цикл по индексам и элементам списка.
'''
for index, value in enumerate(my_list):
    print(index, value)
#-------------------------------------------------------------------------------
''' 039. Функция product генерирует прямое произведение входящих итерируемых данных.
'''
for a, b, c in product(list_a, list_b, list_c):
    if a + b + c == 2077:
        print(a, b, c)
#-------------------------------------------------------------------------------
''' 040. Объединение нескольких итераторов в один.
'''
from itertools import chain

a, b, c = [1, 22], [7, 20], [3, 70]
for i in chain(a, b, c):
    print(i)
# 1,22,7,20,3,70
#-------------------------------------------------------------------------------
''' 041. Создание итератора.
'''
def even_only(num):
    for i in num:
        if i % 2 == 0:
            yield i
#-------------------------------------------------------------------------------
''' 042. Пересечение множества с одной или более последовательностями, поддерживающими итерирование.
'''
sets = {0, 1, 2, 3}
lists = [0, 1, 3, 5, 6, 7]
sets.intersection(lists)         # {0, 1, 3}
          
#-------------------------------------------------------------------------------
''' 043. Наибольший общий делитель
'''
math.gcd(65, 780)          
#-------------------------------------------------------------------------------
''' 044.
